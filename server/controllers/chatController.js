...
exports.getContacts = (req, res) => {
    ...
    try {
        ...
        `;
        pool.query(query, [userId, userId, userId, userId], (qErr, results) => {
            if (qErr) {
...
exports.getThread = (req, res) => {
    ...
    try {
        ...
        `;
        pool.query(query, [userId, contactId, contactId, userId], (qErr, results) => {
            if (qErr) {
                return res.status(500).json({ error: 'Query error' });
            }
...
exports.blockUserToggle = (req, res) => {
    var _a, _b;
    try {
        // Get contact id
