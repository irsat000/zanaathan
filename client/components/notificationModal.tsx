                    ...
                    {notificationCode === 'postExpiration' ?
                        <>
                            <div className="post-expiration-question">
                                ...
                                <p>başlıklı gönderi tamamlandı mı, yoksa hâlâ ustalardan cevap mı bekliyor? İşlem yapmadığınız takdirde bir hafta daha yayında kalıp sonrasında &quot;Tamamlandı&quot; olarak değiştirilecektir. Bu işlemi istediğiniz zaman profilinizden de yapabilirsiniz.</p>
                            </div>
