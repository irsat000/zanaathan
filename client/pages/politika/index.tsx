    ...
    return (
        <Template>
            <div className="legal-page">
                <LegalNav page='terms-and-conditions' />
                <div className="legal-body">
                    <h1>Kullanım Koşulları</h1>
                    <p>Son güncellenme: 01/01/2024</p>
                    <p>
                        Sevgili ziyaretçimiz, lütfen https://zanaathan.com web sitemizi ziyaret etmeden önce işbu
                    ...
                    <p>
                        https://zanaathan.com web sitesi ZanaatHan tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
                    ...
                    <p>
                        ZanaatHan olarak, sunacağımız hizmetlerin kapsamını ve niteliğini, yasalar
                    ...
                    <p>
                        ...
                        (bundan böyle ve daha sonra "içerik" olarak anılacaktır) ZanaatHan olup,
                    ...
                    <p>
                        ...
                        Balıkesir Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.
                    </p>
