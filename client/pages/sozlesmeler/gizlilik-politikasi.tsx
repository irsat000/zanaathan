        ...
        <Template>
            <div className="legal-page">
                ...
                <div className="legal-body">
                    ...
                    <p>
                        Biz, ZanaatHan, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
                    ...
                    <p>Yukarıda sayılan haklarınızı kullanmak üzere muhammedirsat000@gmail.com üzerinden bizimle iletişime geçebilirsiniz.</p>
                    <h2>İletişim</h2>
                    <p>
